...
Los controles de voz de Discord y de reproducción de Spotify se ejecutan en cuanto pulsas la última tecla y no traen la ventana al frente. Discord debe estar abierto y conectado a una llamada para mostrar sus controles; Spotify debe estar abierto. Estos controles no inician la app si está cerrada. Los atajos de apertura siguen ejecutándose al soltar las teclas, para evitar que Win abra el menú Inicio.
